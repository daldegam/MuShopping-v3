	...
	<td valign="top">
					...
					<div class="wrapper-center">
						<div class="clear contentAdminpaneopen">
							<div class="fleft contentAdminheading">
							   <div class="title">{#TITLE} - Administração</div>
							</div>
						</div>
					</div>
				</div>   
        ...
        <div class="contentAdmin-text">
			...
			<td colspan="2" class="article_indent" valign="top">
			    <div class="indent-top text">Seja bem vindo à página inicial da administração shopping, escolha uma das opções no menu acima ou no menu lateral.</div>
			</td>
			</tr>
			</tbody>
			</table>
