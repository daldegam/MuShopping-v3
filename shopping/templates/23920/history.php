	...
	<td valign="top">
        ...
        <div class="content-text">
			...
			<td colspan="2" class="article_indent" valign="top">
                ...
                <em>Total de confirma&ccedil;&otilde;es de dep&oacute;sitos:</em> <strong>{#TOTAL_CONFIRMS}</strong> <a href="?cmd=HistorySystem&amp;Type=confirms">[ver confirma&ccedil;&otilde;es]</a>
                </div>              
                {#LIST_BOX_ITENS}
                {#LIST_CONFIRMS}
			</td>
