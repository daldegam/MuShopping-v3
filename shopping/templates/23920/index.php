	...
	<td valign="top">
        ...
        <div class="content-text">
			...
			<td colspan="2" class="article_indent" valign="top">
			    <div class="indent-top text">Seja bem vindo &agrave; p&aacute;gina inicial do shopping, escolha uma das op&ccedil;&otilde;es no menu acima ou no menu lateral para come&ccedil;ar a navegar.</div>
			</td>
			</tr>
			</tbody>
			</table>
